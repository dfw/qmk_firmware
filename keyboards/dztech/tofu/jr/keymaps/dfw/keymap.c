...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        KC_TAB,         KC_A,    LCTL_T(KC_S), LALT_T(KC_D), LGUI_T(KC_F),     KC_G,    KC_H,    RGUI_T(KC_J), LALT_T(KC_K), LCTL_T(KC_L), KC_QUOT, KC_SCLN,                KC_ENT,  KC_PGDN,
        OSM(MOD_LSFT),  KC_Z,    KC_X,         KC_C,         KC_V,             KC_B,    KC_N,    KC_M,         KC_COMM,      KC_DOT,       KC_SLSH, OSM(MOD_RSFT),          KC_UP,   KC_END,
        KC_LCTL,        KC_LALT, KC_LGUI,                            KC_SPC,                                   MO(2),        KC_RGUI,      KC_RCTL,                KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_65_ansi(
